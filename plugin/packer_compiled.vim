...
augroup packer_load_aucmds
  au!
  " Filetype lazy-loads
  au FileType table: 0x05187a88 ++once call s:load(['vim-clang-format'], { "ft": "table: 0x05187a88" })
  au FileType table: 0x05187a50 ++once call s:load(['vim-clang-format'], { "ft": "table: 0x05187a50" })
