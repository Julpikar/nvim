...
augroup packer_load_aucmds
  au!
  " Filetype lazy-loads
  au FileType table: 0x051835e0 ++once call s:load(['vim-clang-format'], { "ft": "table: 0x051835e0" })
  au FileType table: 0x05183618 ++once call s:load(['vim-clang-format'], { "ft": "table: 0x05183618" })
