...
augroup packer_load_aucmds
  ...
  au FileType table: 0x05210638 ++once call s:load(['vim-clang-format'], { "ft": "table: 0x05210638" })
  au FileType rust ++once call s:load(['rust.vim'], { "ft": "rust" })
  au FileType table: 0x05210690 ++once call s:load(['vim-clang-format'], { "ft": "table: 0x05210690" })
  " Event lazy-loads
augroup END
