...
augroup packer_load_aucmds
  au!
  " Filetype lazy-loads
  au FileType table: 0x05170e50 ++once call s:load(['vim-clang-format'], { "ft": "table: 0x05170e50" })
  au FileType table: 0x05170e88 ++once call s:load(['vim-clang-format'], { "ft": "table: 0x05170e88" })
