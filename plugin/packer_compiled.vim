...
augroup packer_load_aucmds
  au!
  " Filetype lazy-loads
  au FileType table: 0x01189c78 ++once call s:load(['vim-clang-format'], { "ft": "table: 0x01189c78" })
  au FileType table: 0x01185e38 ++once call s:load(['vim-clang-format'], { "ft": "table: 0x01185e38" })
