...
function Colorscheme.setup()
  ...
  nvim_set_hl(0, "NormalFloat", { fg = "#d3c6aa", bg = "#1e2326" })
  nvim_set_hl(0, "FloatBorder", { fg = "#859289", bg = "#1e2326" })
  nvim_set_hl(0, "FloatTitle", { fg = "#d3c6aa", bg = "#1e2326", bold = true })
  --nvim_set_hl(0,'FloatFooter',{})
